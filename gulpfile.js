...
import { swiper_css } from "./gulp/tasks/styles.js";
import { include } from "./gulp/tasks/include.js";
import { scripts } from "./gulp/tasks/scripts.js";
import { swiper_js } from "./gulp/tasks/scripts.js";
...
gulp.task(
  ...
  gulp.series(
    clean,
    normilize,
    gulp.parallel(html, styles, scripts, img, include, swiper_css, swiper_js, cleanFonts, otfConvert, ttfConvert, exportFonts),
    watch
  )
);
